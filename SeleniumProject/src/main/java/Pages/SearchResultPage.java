...
public class SearchResultPage extends BasePage {
    ...
    public SearchResultPage addItem(){
        click(itemSize, driver).click(itemColor, driver).hoverOver(modelImage, driver).click(addToCartButton, driver);
        return this;
    }
    public ItemPage addItemOnly(){
        hoverOver(modelImage, driver).click(addToCartButton, driver);
        return new ItemPage(driver);
    }
    public String getAlertMessage(){
        return getText(alertMessage, driver);
    }
}
